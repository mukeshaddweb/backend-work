...
<html lang="en">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="number" name="hide" value="<?php echo $ohide;?>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
              </div>
  ...
  if(isset($_POST['update'])){
    ...
    if($cid==1){
        echo $id;
      $usql = "update women set name='$name', image_url='$filepath', price=$price, tag='$tag', description='$description', type='$type', hide=$hide where id=$id";

    }elseif($cid==2){
        echo $id;
      $usql = "update children set name='$name', image_url='$filepath', price=$price, tag='$tag', description='$description', type='$type', hide=$hide where id=$id";
        
    }if($cid==3){
        // echo "i am in men category.";
echo $id;
      $usql = "update men set name='$name', image_url='$filepath', price=$price, tag='$tag', description='$description', type='$type', hide=$hide where id=$id";
    }
    ...
    if($uquery){
      ...
      switch($cid){
        case 1: 
          header('Location:fcategory_table.php?id=1');
          break;
        case 2:
          header('Location:fcategory_table.php?id=2');
          break;
        case 3:
          header('Location:fcategory_table.php?id=3');
          break;
        }
    }else{
