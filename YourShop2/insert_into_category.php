...
<?php
  ...
  if(isset($_POST['insert'])){
    ...
    if($sid==1){
      ...
      $sql = "insert into women(name,image_url,price,tag,description,type,hide) values('$name','$filepath',$price,'$tag','$description','$type',$hide)";

    }if($sid==2){

      $sql = "insert into children(name,image_url,price,tag,description,type,hide) values('$name','$filepath',$price,'$tag','$description','$type',$hide)";
        
    }if($sid==3){

      $sql = "insert into men(name,image_url,price,tag,description,type,hide) values('$name','$filepath',$price,'$tag','$description','$type',$hide)";
    }
